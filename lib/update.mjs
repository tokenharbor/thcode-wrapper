...
// codewhale-fork release repo. The old `tokenharbor/thcode` (opencode
// fork) is deprecated — comparing against its tags produced a false
// "update available" signal in the wrapper.
const BINARY_REPO = "tokenharbor/thcode-tui";
