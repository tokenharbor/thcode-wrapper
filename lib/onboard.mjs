...
function buildThcodeConfig(apiKey, models) {
  ...
  return {
    ...
    tools: {
      ls: {
        // Default 1000 = hard refusal on common workspace roots.
        // 5000 lets normal trees through but a 5K-line dump still
        // saturates a 128K-token context. Cap depth at 2 so the agent
        // gets an overview + falls back to glob/grep for drill-down.
        max_depth: 2,
        max_items: 1000,
      },
    },
