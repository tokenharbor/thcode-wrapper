    ...
    providers: {
      tokenharbor: {
        ...
        system_prompt_prefix: [
          ...
          "PATHS: When the user mentions a directory or file (e.g. `~/Documents/TDI`), use that EXACT path in your first tool call. Don't substitute, generalize, or pick a different directory.",
          "TRUNCATION: '(N lines hidden) [click or space to expand]' in a tool result is the TUI compressing display for the human reader. The FULL output is already in your context. Never claim the user's message was truncated.",
        ].join("\n\n"),
      },
    },
    models: {
